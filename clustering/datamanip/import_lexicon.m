function lexicon = import_lexicon(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   DOMINANCE1 = IMPORTFILE(FILENAME) Reads data from text file FILENAME
%   for the default selection.
%
%   DOMINANCE1 = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   dominance1 = importfile('dominance', 1, 1034);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2016/02/09 09:54:01
